...
export default function Agents() {
  return <div className="utility-page"><a className="back-link" href={asset('')}>Back to collection</a><article className="prose"><h1>For agents</h1><p>Everything in this collection is available as static content. You can discover templates, read their metadata, and retrieve the original YAML without running the site’s JavaScript.</p>
    <div className="inline-links"><a href={asset('catalog.json')}>Catalog JSON</a><a href={asset('llms.txt')}>llms.txt</a></div>
