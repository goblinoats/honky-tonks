...
export default function Agents() {
  return <><a className="back-link" href={asset('')}>← Back to the collection</a><article className="prose"><p className="eyebrow">FOR AGENTS</p><h1>Small software.<br />Readable source.</h1><p>Everything in this collection is available as static content. You can discover templates, read their metadata, and retrieve the original YAML without running the site’s JavaScript.</p>
